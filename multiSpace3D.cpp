...
fileSelector.setSelectorFontSize(14);
fileSelector.setSelectFontSize(14);
...
tip[1]="Fichier";
tip[2]="Enregistrer";
tip[3]="Nouvelle instance";
tip[4]="Supprimer mixer";
tip[5]="Supprimer groupe";
tip[6]="Tout supprimer";
tip[7]="Deplacement : mixer";
tip[8]="Deplacement : groupe";
tip[9]="Tout deplacer";
tip[10]="Expension groupe";
tip[11]="Contraction groupe";
tip[12]="Rotation Z";
tip[13]="Rotation X";
tip[14]="Rotation Y";
tip[15]="Recherche/Creation de mixer";
tip[16]="Nouveau studio";
tip[17]="Fenetre 3D";
//************************************************************************************************
//                                              init win3D
//************************************************************************************************
...
void onMouseMove(sf::Event e){
   ...
   if(e.mouseMove.y<30){
   	...
   	if(e.mouseMove.x>72 && e.mouseMove.x<102){
   	  ...
   	  toolType.setPosition(e.mouseMove.x+32,e.mouseMove.y+24);
   	  toolType.setFillColor(sf::Color(0,0,0,255));
   	}
   	...
   	if(e.mouseMove.x>146 && e.mouseMove.x<170){
   	  bkgToolType.setPosition(e.mouseMove.x+20,e.mouseMove.y+20);
   	  bkgToolType.setFillColor(sf::Color(203,213,217,255));
   	  bkgToolType.setSize(sf::Vector2f(96,24));
   	...
   	if(e.mouseMove.x>196 && e.mouseMove.x<218){
   	  bkgToolType.setPosition(e.mouseMove.x+20,e.mouseMove.y+20);
   	  bkgToolType.setFillColor(sf::Color(203,213,217,255));
   	  bkgToolType.setSize(sf::Vector2f(90,24));
   	...
   	if(e.mouseMove.x>220 && e.mouseMove.x<248){
   	  bkgToolType.setPosition(e.mouseMove.x+20,e.mouseMove.y+20);
   	  bkgToolType.setFillColor(sf::Color(203,213,217,255));
   	  bkgToolType.setSize(sf::Vector2f(118,24));
   	...
   	if(e.mouseMove.x>248 && e.mouseMove.x<276){
   	  bkgToolType.setPosition(e.mouseMove.x+20,e.mouseMove.y+20);
   	  bkgToolType.setFillColor(sf::Color(203,213,217,255));
   	  bkgToolType.setSize(sf::Vector2f(126,24));
   	...
   	if(e.mouseMove.x>276 && e.mouseMove.x<304){
   	  bkgToolType.setPosition(e.mouseMove.x+20,e.mouseMove.y+20);
   	  bkgToolType.setFillColor(sf::Color(203,213,217,255));
   	  bkgToolType.setSize(sf::Vector2f(82,24));
   	...
   	if(e.mouseMove.x>504 && e.mouseMove.x<580){
   	  bkgToolType.setPosition(e.mouseMove.x+20,e.mouseMove.y+20);
   	  bkgToolType.setFillColor(sf::Color(203,213,217,255));
   	  bkgToolType.setSize(sf::Vector2f(166,24));
   	...
   	if(e.mouseMove.x>696 && e.mouseMove.x<726){
   	  bkgToolType.setPosition(e.mouseMove.x+20,e.mouseMove.y+20);
   	  bkgToolType.setFillColor(sf::Color(203,213,217,255));
   	  bkgToolType.setSize(sf::Vector2f(68,24));
